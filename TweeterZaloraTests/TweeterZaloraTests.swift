...
import XCTest
@testable import TweeterZalora

class TweeterZaloraTests: XCTestCase {
    ...
    func testTweetMessageLengthLessThanMaximum() {
        ...
        let output = Helper.tweet(messageInput: input, limit: limit)
    ...
    func testEdgeCases() {
        ...
        //When
        let output = Helper.tweet(messageInput: msgs, limit: limit)
